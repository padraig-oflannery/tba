      ...
      <div className="grid grid-cols-1 px-4 gap-6">
        <div className="flex flex-col gap-4 items-center justify-center">
          <div className="w-[200px] h-[300px] relative shadow-xl rounded-lg overflow-hidden">
            <Image
              src="/images/board/molly.jpeg"
              alt="Molly Jante Cover"
              fill
              className="object-cover"
            />
          </div>
          <div className="flex flex-col items-center justify-center">
            <span className="text-white font-bold text-2xl select-none text-center">
              Molly Jante
            </span>
            <span className="text-white font-light text-base select-none text-center">
              President
            </span>
          </div>
        </div>
        <div className="flex flex-col gap-4 items-center justify-center">
          <div className="w-[200px] h-[300px] relative shadow-xl rounded-lg overflow-hidden">
            <Image
              src="/images/board/wes.jpeg"
              alt="Wes Garner Cover"
              fill
              className="object-cover"
            />
          </div>
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          <div className="w-[200px] h-[300px] relative shadow-xl rounded-lg overflow-hidden">
            <Image
              src="/images/board/kim.jpeg"
              alt="Kim Garner Cover"
              fill
              className="object-cover"
            />
          </div>
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          <div className="w-[200px] h-[300px] relative shadow-xl rounded-lg overflow-hidden">
            <Image
              src="/images/board/kaylee.jpeg"
              alt="Kaylee Corr Cover"
              fill
              className="object-cover"
            />
          </div>
