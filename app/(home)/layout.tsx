  ...
  return (
    <div className="bg-[#779a46] w-full h-screen flex items-center justify-center gap-4 flex-col">
      ...
      <span className="text-white font-light text-lg">
        You are trying to access this webpage from a non-mobile device.
      </span>
      <span className="text-white font-light text-lg">
        Return to this site when you have a mobile device to view the content.
      </span>
...
const MainLayout = ({ children }: LayoutProps) => {
  ...
  return <PageWrapperMobile>{children}</PageWrapperMobile>;
};
